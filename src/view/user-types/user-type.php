        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6 ellipsis">
                    <h1 class="d-inline-block"> Tipo Usuário </h1>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= $this->route ?>">Tipo Usuário</a></li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-header p-0 pt-1">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <?php if (isset($idUserType) && $idUserType) : ?>
                                    <li class="nav-item">
                                        <a href="<?= "$this->route/access/$idUserType" ?>" class="nav-link <?= $_GET['pg2'] == "access" ? "active" : '' ?>" role="tab" aria-controls="access">Acesso</a>
                                    </li>
                                <?php endif ?>
                            </ul>
                        </div>
